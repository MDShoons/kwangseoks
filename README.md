...
## v138-v137-stabilized-relations
- v137 관계형 엔진을 v136 안정 구조 위에서 재이식했습니다.
- 회원↔회원, 김광석↔회원, 본인↔회원, 본인↔김광석, 본인↔김광석+회원 분기를 추가했습니다.
- 사이트 전체를 깨뜨릴 수 있는 과한 통신방 엔진 교체 대신 안정형 래퍼 함수 방식으로 적용했습니다.
