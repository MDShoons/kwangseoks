...
## v17 영상 인라인 재생 수정
- 영상 자료를 클릭해 상세창을 열 때 주소창의 `/bbs/board.php?...` 형식은 유지합니다.
- 상세창 안의 영상은 사이트 안에서만 재생되도록 정리했습니다.
- 브라우저 기본 영상 전체화면 버튼/더블클릭 전체화면 전환을 차단했습니다.
- 기존 Firebase, 로그인, 관리자, 자료등록 기능은 유지했습니다.


[v24] 공연자료 상세보기 다중 이미지 슬라이더 추가.
