...
## v140-zeta-like-dialogue-flow
- 통신방 대화 흐름 보정: 대상 인식, 최근 주제 기억, 관계별 반응, 회원↔회원/김광석↔회원/본인↔회원/본인↔김광석/본인↔김광석+회원 구조 강화.


## v141-ai-to-ai-dialogue
- 통신방에서 AI 회원끼리 질문→답변→끼어들기 대화 묶음이 생성되도록 보강했습니다.
