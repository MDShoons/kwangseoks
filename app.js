...
document.querySelectorAll(
  "#settingBodyBgColor, #settingHeaderBgColor, #settingButtonColor, #settingCardBgColor, #settingTextColor, #settingHeroTextColor, #settingNavTextColor, #settingBaseFontSize, #settingHeroTitleSize, #settingHeroDescSize"
).forEach((el) => {
  el.addEventListener("input", () => {
    applyDesignSettings({ ...currentSettings, ...readDesignSettingsFromForm() });
  });
});
...
if (resetDesignBtn) {
  resetDesignBtn.addEventListener("click", () => {
    const defaults = {
      settingBodyBgColor: DEFAULT_SETTINGS.bodyBgColor,
      settingHeaderBgColor: DEFAULT_SETTINGS.headerBgColor,
      settingButtonColor: DEFAULT_SETTINGS.buttonColor,
      settingCardBgColor: DEFAULT_SETTINGS.cardBgColor,
      settingTextColor: DEFAULT_SETTINGS.textColor,
      settingHeroTextColor: DEFAULT_SETTINGS.heroTextColor,
      settingNavTextColor: DEFAULT_SETTINGS.navTextColor,
      settingBaseFontSize: DEFAULT_SETTINGS.baseFontSize,
      settingHeroTitleSize: DEFAULT_SETTINGS.heroTitleSize,
      settingHeroDescSize: DEFAULT_SETTINGS.heroDescSize
    };
    ...
    applyDesignSettings({
      bodyBgColor: DEFAULT_SETTINGS.bodyBgColor,
      headerBgColor: DEFAULT_SETTINGS.headerBgColor,
      buttonColor: DEFAULT_SETTINGS.buttonColor,
      cardBgColor: DEFAULT_SETTINGS.cardBgColor,
      textColor: DEFAULT_SETTINGS.textColor,
      heroTextColor: DEFAULT_SETTINGS.heroTextColor,
      navTextColor: DEFAULT_SETTINGS.navTextColor,
      baseFontSize: DEFAULT_SETTINGS.baseFontSize,
      heroTitleSize: DEFAULT_SETTINGS.heroTitleSize,
      heroDescSize: DEFAULT_SETTINGS.heroDescSize
    });
...
function applyDesignSettings(settings) {
  ...
  root.style.setProperty("--body-bg", settings.bodyBgColor || DEFAULT_SETTINGS.bodyBgColor);
  root.style.setProperty("--header-bg", settings.headerBgColor || DEFAULT_SETTINGS.headerBgColor);
  root.style.setProperty("--button-bg", settings.buttonColor || DEFAULT_SETTINGS.buttonColor);
  root.style.setProperty("--card-bg", settings.cardBgColor || DEFAULT_SETTINGS.cardBgColor);
  root.style.setProperty("--text-color", settings.textColor || DEFAULT_SETTINGS.textColor);
  root.style.setProperty("--hero-text-color", settings.heroTextColor || DEFAULT_SETTINGS.heroTextColor);
  root.style.setProperty("--nav-text-color", settings.navTextColor || DEFAULT_SETTINGS.navTextColor);

  root.style.setProperty("--base-font-size", `${settings.baseFontSize || DEFAULT_SETTINGS.baseFontSize}px`);
  root.style.setProperty("--hero-title-size", `${settings.heroTitleSize || DEFAULT_SETTINGS.heroTitleSize}px`);
  root.style.setProperty("--hero-desc-size", `${settings.heroDescSize || DEFAULT_SETTINGS.heroDescSize}px`);
}

function fillDesignFormFromCurrent() {
  const pairs = {
    settingBodyBgColor: currentSettings.bodyBgColor || DEFAULT_SETTINGS.bodyBgColor,
    settingHeaderBgColor: currentSettings.headerBgColor || DEFAULT_SETTINGS.headerBgColor,
    settingButtonColor: currentSettings.buttonColor || DEFAULT_SETTINGS.buttonColor,
    settingCardBgColor: currentSettings.cardBgColor || DEFAULT_SETTINGS.cardBgColor,
    settingTextColor: currentSettings.textColor || DEFAULT_SETTINGS.textColor,
    settingHeroTextColor: currentSettings.heroTextColor || DEFAULT_SETTINGS.heroTextColor,
    settingNavTextColor: currentSettings.navTextColor || DEFAULT_SETTINGS.navTextColor,
    settingBaseFontSize: currentSettings.baseFontSize || DEFAULT_SETTINGS.baseFontSize,
    settingHeroTitleSize: currentSettings.heroTitleSize || DEFAULT_SETTINGS.heroTitleSize,
    settingHeroDescSize: currentSettings.heroDescSize || DEFAULT_SETTINGS.heroDescSize
  };
