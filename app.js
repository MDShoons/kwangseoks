...
async function uploadFileToGitHubWorker(file, folder = "images") {
  ...
  try {
    ...
    throw new Error(
      "Cloudflare Worker에 연결하지 못했습니다. Worker 주소, Deploy 여부, ALLOWED_ORIGIN, CORS 설정을 확인하세요. " +
      "브라우저에서 https://kwangseoks.kos20050627.workers.dev/upload 를 열었을 때 JSON 오류가 보여야 정상입니다."
    );
  }
